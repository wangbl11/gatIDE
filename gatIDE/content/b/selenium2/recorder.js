...
builder.selenium2.Recorder.prototype = {
  ...
  writeJsonSwitchFrameIfNeeded: function(element) {
    ...
    console.log('end choosing window');
  },
  /**
  ...
  writeJsonClicks: function(e) {
    ...
    if (locator){
    	console.log(locator.getValue());
    }
    
    var lastStep = null;//this.getLastRecordedStep(); //builder.getScript().getLastStep();
    console.log('analysis locators');
    ...
    console.log('done select/option');
    ...
    */
    ...
    //browser.runtime.sendMessage({"url": "test"});
    /*
    if (e.type == 'dblclick') {
...
console.log('selenium2/recorder.js');
